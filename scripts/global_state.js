...
window.openRouterPrimaryEnabledCheckbox = document.getElementById('openRouterPrimaryEnabledCheckbox');
window.openRouterModelInput = document.getElementById('openRouterModelInput');
window.openRouterFallbackModel1EnabledCheckbox = document.getElementById('openRouterFallbackModel1EnabledCheckbox');
window.openRouterFallbackModel1Input = document.getElementById('openRouterFallbackModel1Input');
window.openRouterFallbackModel2EnabledCheckbox = document.getElementById('openRouterFallbackModel2EnabledCheckbox');
...
window.openRouterFallbackModel2 = 'qwen/qwen3.6-plus-preview:free';
